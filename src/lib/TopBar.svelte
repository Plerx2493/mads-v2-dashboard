  ...
  <div class="topbar-content">
    ...
    <div class="user-section" bind:this={dropdownElement}>
      <button class="user-button" on:click={toggleDropdown}>
        ...
        <svg class="dropdown-icon {dropdownOpen ? 'open' : ''}" width="12" height="12" viewBox="0 0 12 12">
        ...
        <div class="dropdown-menu">
          <button class="dropdown-item" on:click={handleProfile}>
            <svg width="16" height="16" viewBox="0 0 16 16">
              <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM8 9a5 5 0 0 0-5 5h10a5 5 0 0 0-5-5z" fill="currentColor"/>
            </svg>
            Profile
          </button>
